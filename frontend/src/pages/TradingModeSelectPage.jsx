...
const TRADING_MODES = [
    { id: 'demo', title: 'Demo Trading', icon: GraduationCap, color: '#0EA5E9', active: true },
    { id: 'live', title: 'Live Trading', icon: Zap, color: '#0EA5E9', active: true },
    ...
    return (
        <div
            className={`
                ...
                ${mode.active
                    ? 'border-[#0EA5E9]/30 hover:border-[#0EA5E9]/60 hover:scale-[1.04] hover:shadow-[0_20px_50px_rgba(14,165,233,0.14)]'
                    : 'border-white/10 opacity-65 hover:opacity-85'
                }
            `}
            style={{
                background: mode.active ? 'rgba(15, 23, 42, 0.82)' : 'rgba(15, 23, 42, 0.72)',
                border: mode.active ? '1px solid rgba(14,165,233,0.28)' : '1px solid rgba(148,163,184,0.16)',
        ...
        >
            ...
            {mode.active && (
                <div className="mt-2 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-1 group-hover:translate-y-0">
                    <div className="flex items-center gap-1 text-[10px] font-semibold text-[#38BDF8]">
                        <span>Start</span>
    ...
    return (
        <div className="min-h-screen w-full overflow-x-hidden bg-surface-950">
            ...
            <div className="fixed inset-0 pointer-events-none">
                <div className="absolute top-0 left-1/4 w-[600px] h-[600px] rounded-full bg-[#0EA5E9]/[0.06] blur-[120px]" />
            ...
            <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
                ...
                >
                    ...
                    <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0EA5E9]/10 border border-[#0EA5E9]/20 mb-4 backdrop-blur-md">
                    ...
                    <h1 className="text-3xl sm:text-4xl font-black text-white tracking-tight mb-2">
                        Choose Your{' '}
                        <span className="bg-gradient-to-r from-[#0EA5E9] via-[#38BDF8] to-cyan-300 bg-clip-text text-transparent">
                            Trading Mode
                        </span>
                    </h1>
