...
function StrengthBar({ password }) {
  ...
  const configs = [
    ...
    { label: "Fair", bar: "bg-[#0EA5E9]", text: "text-[#0EA5E9]" },
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <div className="relative group">
                      <User className="absolute left-3 top-1/2 -translate-y-1/2 w-[14px] h-[14px] text-slate-400 group-focus-within:text-[#0EA5E9] transition-colors" />
                      <input
                        type="text"
                  ...
                  <div>
                    ...
                    <div className="relative group">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[12px] text-slate-400 font-mono group-focus-within:text-[#0EA5E9] transition-colors select-none">
                        @
                      </span>
                      <input
                        type="text"
                ...
                <div>
                  ...
                  <div className="relative group">
                    <Mail className="absolute left-3 top-1/2 -translate-y-1/2 w-[14px] h-[14px] text-slate-400 group-focus-within:text-[#0EA5E9] transition-colors" />
                    <input
                      type="email"
                ...
                <div>
                  ...
                  <div className="relative group">
                    <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-[14px] h-[14px] text-slate-400 group-focus-within:text-[#0EA5E9] transition-colors" />
                    <input
