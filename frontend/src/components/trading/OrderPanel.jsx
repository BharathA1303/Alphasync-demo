 ...
 * }} props
 */
export default function OrderPanel({ symbol, currentPrice = 0, isTerminalFocused = false, initialSide, initialSideKey }) {
    ...
    }, [initialSide, initialSideKey, setSide]);
        ...
        <div className="flex flex-col h-full bg-surface-900 border-l border-edge/10">
            ...
            <div className="flex-1 overflow-y-auto px-4 py-3 space-y-4">
                ...
                <div>
                    ...
                    <div className="flex rounded-xl overflow-hidden border border-edge/10 bg-surface-800/60 p-0.5 gap-0.5">
                        {Object.values(TRADING_MODE).map((mode) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        isActive
                                            ? mode === TRADING_MODE.DELIVERY
                                                ? 'bg-blue-600/20 text-blue-400 border border-blue-500/30 shadow-sm'
                                                : 'bg-amber-600/20 text-amber-400 border border-amber-500/30 shadow-sm'
                                            : 'text-gray-500 hover:text-gray-400 hover:bg-surface-700/40 border border-transparent'
                                    )}
                                >
            ...
            <div className="sticky bottom-0 px-4 py-3 border-t border-edge/5 bg-surface-900">
                ...
                <Button
                    ...
                    className={cn(
                        ...
                        (sellBlocked || qtyExceedsHoldings) && "!opacity-40 !cursor-not-allowed !shadow-none !bg-gray-600 hover:!bg-gray-600"
                    )}
                    onClick={() => {
                        if (sellBlocked || qtyExceedsHoldings) return;
                        setConfirmOpen(true);
                    }}
                    isLoading={isSubmitting}
                    disabled={isSubmitting || sellBlocked || qtyExceedsHoldings}
                >
                    {isBuy
                        ? `Place Buy Order`
                ...
                <div className="px-6 py-4 space-y-4">
                    ...
                    {sellBlocked && (
                        <div className="px-3 py-2 rounded-lg bg-red-500/10 border border-red-500/20 text-xs text-red-400">
                            No holdings for {symbol?.replace('.NS', '')}. Switch to Intraday for short selling.
                        </div>
                    )}
