            ...
            <div className="px-3 py-2 border-b border-edge/5 flex items-center gap-2 flex-shrink-0">
                ...
                <div className="relative flex-shrink-0" ref={addRef}>
                    <button
                        ...
                        className="p-1.5 rounded-lg text-gray-500 hover:text-primary-600 hover:bg-primary-500/10 transition-all"
                        title="Add symbol"
                    >
            ...
            <div ref={scrollEl} className="flex-1 min-h-0 overflow-y-auto overflow-x-hidden">
                {isLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-40 text-gray-600 text-xs">
                        ...
                        {!search && (
                            <button onClick={() => setShowAddPanel(true)} className="mt-2 text-primary-600 hover:underline">
                                + Add symbols
                            </button>
                        )}
                    </div>
