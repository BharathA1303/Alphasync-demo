...
import { ORDER_SIDE, ORDER_TYPE, TRADING_MODE, TRADING_MODE_PRODUCT } from '../utils/constants';
import toast from 'react-hot-toast';

/**
 * Normalize symbol for comparison (ensure .NS suffix).
 */
function _norm(s) {
...
export function useOrders(symbol, currentPrice = 0) {
    ...
    const [form, setForm] = useState({
        ...
        trading_mode: TRADING_MODE.DELIVERY,
        product_type: TRADING_MODE_PRODUCT[TRADING_MODE.DELIVERY], // CNC
        quantity: 1,
        price: '',
        triggerPrice: '',
    });
    ...
    const resetForm = useCallback(() => {
        setForm({
            ...
            order_type: ORDER_TYPE.MARKET,
            trading_mode: TRADING_MODE.DELIVERY,
            product_type: TRADING_MODE_PRODUCT[TRADING_MODE.DELIVERY],
            quantity: 1,
            price: '',
            triggerPrice: '',
        });
